...
# 云短信业务配置
TENCENT_APPID = 1400658965  # 自己应用ID
TENCENT_APPKEY = "5181492b50eab6746563be51cdd27981"  # 自己应用Key
TENCENT_SMS_SIGN = "Python知识分享"  # 自己腾讯云创建签名时填写的签名内容（使用公众号的话这个值一般是公众号全称或简称）

# 对象存储配置
COS_SECRET_ID = 'AKIDPZT6TZNvDD1YpunRpyrSmqd9OM3TcWHl'
COS_SECRET_KEY = 'av1rRkmY4KI1ScV7SWJq65nEPJvGK7cq'
